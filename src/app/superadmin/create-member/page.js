    ...
    (async () => {
      try {
        const response = await interceptor.get(
          `${base_url}/superadmin/addmemberdetails/?masjid_id=${formData.selectedMasjid}`
        );
        console.log(response);
        setAddMemberDetails({
          masjids: response.data.details.masjids || [],
